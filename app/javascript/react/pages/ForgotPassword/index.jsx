...
function ForgotPassword() {
    ...
    return (<Authentication_1.default>
      <Container_1.default.Small>
        {!isSubmitSuccess ?
            <Form_1.default.Mutation data-track="forgotPassword" mutation={Mutation_1.default} onSubmit={handleSubmit} setFormObj={setFormObj}>

            <Form_1.default.Input name="email" label="Email" control={Form_1.default.Email}/>

            <Button_1.default type="submit" title="Forgot Password"/>
          </Form_1.default.Mutation> : <>Reset Password URL Sent To Your Email</>}
      </Container_1.default.Small>
